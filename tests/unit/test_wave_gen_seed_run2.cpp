/**
 * @file test_wave_gen_seed_run2.cpp
 * @brief Wave Generation seed test - Run 2 with seed 54321
 * 
...
TEST(WaveGenSeedRun2, GenerateWithSeed54321) {
    WaveGenParams params;
    params.type = PRBSType::PRBS31;
    
    const unsigned int SEED = 54321;
    WaveGenTestbench* tb = new WaveGenTestbench("tb_seed_run2", params, 80e9, SEED, 100);
