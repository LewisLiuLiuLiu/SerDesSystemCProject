/**
 * @file test_wave_gen_repro_run1.cpp
 * @brief Wave Generation reproducibility test - Run 1
 * 
...
TEST(WaveGenReproRun1, GenerateSamples) {
    WaveGenParams params;
    params.type = PRBSType::PRBS31;
    
    const unsigned int SEED = 12345;
    WaveGenTestbench* tb = new WaveGenTestbench("tb_repro_run1", params, 80e9, SEED, 100);
